...
You'll see that the second agent will respond using information from the [checkpoint](/oss/langgraph/persistence#checkpoints) generated in the thread by the first agent as context.
