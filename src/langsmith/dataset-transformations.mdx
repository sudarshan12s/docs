...
The LLM run collection schema is built to collect data from LangChain @[`BaseChatModel`] runs or traced runs from the [LangSmith OpenAI wrapper](/langsmith/annotate-code#use-traceable--traceable).
