...
flowchart TB
    ...
    style Redis fill:#D82C20,stroke:#a11b14,color:#fff
    style API fill:#E0F3FF,stroke:#333,stroke-width:1px
    style WorkerContainer fill:#E0FFE0,stroke:#333,stroke-width:1px
```
