...
:::python
Open-weight models are available through providers like [OpenRouter](/oss/integrations/providers/openrouter), [Baseten](/oss/integrations/providers/baseten), and [Ollama](/oss/integrations/providers/ollama).
:::

:::js
Open-weight models are available through providers like [OpenRouter](/oss/integrations/providers/openrouter).
:::
