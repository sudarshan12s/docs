...
| [`OracleDocLoader`](/oss/integrations/document_loaders/file_loaders/oracleai) | Ingest Oracle AI Vector Search tables or Oracle Text-supported files | Package |
...
<Card title="OracleDocLoader" icon="link" href="/oss/integrations/document_loaders/file_loaders/oracleai" arrow="true" cta="View guide" />
