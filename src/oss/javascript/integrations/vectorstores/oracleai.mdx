...
The example below assumes that you already created a table with vector and metadata columns and generated embeddings using [`OracleEmbeddings`](/oss/integrations/embeddings/oracleai).
...
- Generate embeddings with [`OracleEmbeddings`](/oss/integrations/embeddings/oracleai)
