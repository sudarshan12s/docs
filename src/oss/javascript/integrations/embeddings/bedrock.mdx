...
This will help you get started with Amazon Bedrock [embedding models](/oss/integrations/embeddings) using LangChain. For detailed documentation on `Bedrock` features and configuration options, please refer to the [API reference](https://api.js.langchain.com/classes/langchain_aws.BedrockEmbeddings.html).
