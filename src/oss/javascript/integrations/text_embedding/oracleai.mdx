...
| :--- | :--- | :---: | :---: |
| [OracleEmbeddings](https://api.js.langchain.com/classes/langchain_oracle.OracleEmbeddings.html) | [`@langchain/oracle`](https://www.npmjs.com/package/@langchain/oracle) | ✅ | ✅ |

## Setup

To use @[OracleEmbeddings], install the `@langchain/oracle` helpers plus the [`oracledb`](https://www.npmjs.com/package/oracledb) driver that opens database connections.
...
```typescript
import { OracleDocLoader, OracleTextSplitter } from "@langchain/oracle";
