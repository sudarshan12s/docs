...
| :--- | :--- | :---: | :---: |
| [OracleSummary](https://api.js.langchain.com/classes/langchain_oracle.OracleSummary.html) | [`@langchain/oracle`](https://www.npmjs.com/package/@langchain/oracle) | ✅ | ✅ |

## Setup

To access @[OracleSummary], install the `@langchain/oracle` helpers plus the [`oracledb`](https://www.npmjs.com/package/oracledb) driver used for database connections.
...
- Generate embeddings using [`OracleEmbeddings`](/oss/javascript/integrations/text_embedding/oracleai) and store them in [`OracleVS`](/oss/javascript/integrations/vectorstores/oracleai)
...
For detailed documentation of all @[OracleSummary] parameters and return types, see the [OracleSummary API reference](https://api.js.langchain.com/classes/langchain_oracle.OracleSummary.html).
