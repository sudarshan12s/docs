...
This will help you get started with NVIDIA [chat models](/oss/langchain/models). For detailed documentation of all `ChatNVIDIA` features and configurations head to the [API reference](https://reference.langchain.com/python/langchain-nvidia-ai-endpoints/chat_models/ChatNVIDIA).
...
For more information on accessing embedding models through this API, refer to the [`NVIDIAEmbeddings`](/oss/integrations/embeddings/nvidia_ai_endpoints) documentation.
