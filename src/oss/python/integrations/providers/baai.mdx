...
See a [usage example](/oss/integrations/embeddings/bge_huggingface).
...
See a [usage example running model on Intel CPU](/oss/integrations/embeddings/ipex_llm).
See a [usage example running model on Intel GPU](/oss/integrations/embeddings/ipex_llm_gpu).
...
See a [usage example](/oss/integrations/embeddings/itrex).
