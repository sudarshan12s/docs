...
<AccordionGroup>
    <Accordion title="VertexAIEmbeddings (deprecated)">
        **Deprecated**—Use [`GoogleGenerativeAIEmbeddings`](/oss/integrations/embeddings/google_generative_ai) instead.
...
<Columns cols={2}>
    ...
    <Card title="Vertex AI Vector Search + Datastore" href="/oss/integrations/vectorstores/google_vertex_ai_vector_search#optional--you-can-also-create-vectore-and-store-chunks-in-a-datastore" cta="Get started" arrow>
