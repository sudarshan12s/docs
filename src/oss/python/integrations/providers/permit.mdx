...
See detail on available tools in the [Permit tools documentation](/oss/integrations/tools/permit).

## Retrievers

See detail on available retrievers in the [Permit retrievers documentation](/oss/integrations/retrievers/permit).
