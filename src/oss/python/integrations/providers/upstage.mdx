...
| Text Embedding | Embed strings to vectors | `from langchain_upstage import UpstageEmbeddings` | [Go](/oss/integrations/embeddings/upstage) |
...
See [a usage example](/oss/integrations/embeddings/upstage).
