...
|Text Embedding|Embed strings to vectors|[embed](https://docs.cohere.com/reference/embed)|`from langchain_cohere import CohereEmbeddings`|[cohere.ipynb](/oss/integrations/embeddings/cohere)|
...
Usage of the Cohere [Text Embeddings model](/oss/integrations/embeddings/cohere)
